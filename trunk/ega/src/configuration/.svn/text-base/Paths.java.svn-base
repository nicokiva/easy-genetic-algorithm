...
public class Paths {
    ...
    public String strAyudanteMetodos = this.strMetodos + "\\" + this.strAyudante;
    
    //public String strInformesResultados = "inf\\";
    public String strInformesResultados = "data\\";
    public String strInformePrefijo = "inf-";
    public String strResultadoPrefijo = "res-";
    
    public String strRecursosCarpeta = this.strSystem + "\\" + this.strResources;
