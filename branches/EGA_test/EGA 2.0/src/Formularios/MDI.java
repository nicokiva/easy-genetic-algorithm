...
public class MDI extends javax.swing.JFrame {
    ...
    public void AbrirVentana (String strClase, boolean blnSelectFile){
        ...
        if (!strPathSolution.isEmpty()){
            ...
            switch (strClase){
                case "frmSolucion":
                    frm = new frmSolucion(this, this.generateNewSolutionID(), strPathSolution);
                    break;
            }
            this.open(frm);
        }
    ...
    public void AbrirVentana (String strClase, Integer intID, Method strMethod, boolean canSaveAs){
        javax.swing.JInternalFrame frm = new javax.swing.JInternalFrame();
    ...
    public void AbrirVentana ( String strClase )
    {
        ...
        switch (strClase) 
        {
            ...
            case "frmRecursos":
            frm = new frmRecursos(this, this.generateNewSolutionID());
            break;
    ...
    public void open(javax.swing.JInternalFrame frm){
        ...
        (Contenedor.getHeight()- frm.getHeight())/2);
