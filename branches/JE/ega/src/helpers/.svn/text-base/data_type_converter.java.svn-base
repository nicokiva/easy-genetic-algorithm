...
public class data_type_converter {
    ...
    public String fromMethodToByteString(){
        ...
        for (Method method : this._arrMethods){
            ...
            this._strText += method.getIndex() + this._strFieldSeparator + method.getName() + this._strFieldSeparator + method.getAlias()
                + this._strFieldSeparator + method.getDescription() + this._strFieldSeparator + inSystem + this._strFieldSeparator
                + method.getPath() + this._strFieldSeparator + method.getCreated() + this._strFieldSeparator + method.getModified() + this._strLineSeparator;
        }
        
        this._strText.replace("\\", ""); // Not replacing this value
